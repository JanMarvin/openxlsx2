...
std::string Ftab(const uint16_t val) {
  ...
  case	0x0002:	return "ISNA";
  case	0x0003:	return "ISERROR";
  case	0x0004:	return "SUM";
  case	0x0005:	return "AVERAGE";
  case	0x0006:	return "MIN";
  case	0x0007:	return "MAX";
  case	0x0008:	return "ROW";
  case	0x0009:	return "COLUMN";
  case	0x000A:	return "NA";
  case	0x000B:	return "NPV";
  case	0x000C:	return "STDEV";
  case	0x000D:	return "DOLLAR";
  case	0x000E:	return "FIXED";
  case	0x000F:	return "SIN";
  case	0x0010:	return "COS";
  case	0x0011:	return "TAN";
  case	0x0012:	return "ATAN";
  case	0x0013:	return "PI";
  case	0x0014:	return "SQRT";
  case	0x0015:	return "EXP";
  case	0x0016:	return "LN";
  case	0x0017:	return "LOG10";
  case	0x0018:	return "ABS";
  case	0x0019:	return "INT";
  case	0x001A:	return "SIGN";
  case	0x001B:	return "ROUND";
  case	0x001C:	return "LOOKUP";
  case	0x001D:	return "INDEX";
  case	0x001E:	return "REPT";
  case	0x001F:	return "MID";
  case	0x0020:	return "LEN";
  case	0x0021:	return "VALUE";
  case	0x0022:	return "TRUE";
  case	0x0023:	return "FALSE";
  case	0x0024:	return "AND";
  case	0x0025:	return "OR";
  case	0x0026:	return "NOT";
  case	0x0027:	return "MOD";
  ...
  case	0x0041:	return "DATE";
  case	0x0042:	return "TIME";
  case	0x0043:	return "DAY";
  case	0x0044:	return "MONTH";
  case	0x0045:	return "YEAR";
  case	0x0046:	return "WEEKDAY";
  case	0x0047:	return "HOUR";
  case	0x0048:	return "MINUTE";
  case	0x0049:	return "SECOND";
  case	0x004A:	return "NOW";
  case	0x004B:	return "AREAS";
  case	0x004C:	return "ROWS";
  case	0x004D:	return "COLUMNS";
  case	0x004E:	return "OFFSET";
  case	0x004F:	return "ABSREF";
  case	0x0050:	return "RELREF";
  case	0x0051:	return "ARGUMENT";
  case	0x0052:	return "SEARCH";
  case	0x0053:	return "TRANSPOSE";
  case	0x0054:	return "ERROR";
  case	0x0055:	return "STEP";
  case	0x0056:	return "TYPE";
  case	0x0057:	return "ECHO";
  case	0x0058:	return "SET.NAME";
  case	0x0059:	return "CALLER";
  case	0x005A:	return "DEREF";
  ...
  case	0x0061:	return "ATAN2";
  case	0x0062:	return "ASIN";
  case	0x0063:	return "ACOS";
  ...
  case	0x0069:	return "ISREF";
  case	0x006A:	return "GET.FORMULA";
  case	0x006B:	return "GET.NAME";
  case	0x006C:	return "SET.VALUE";
  case	0x006D:	return "LOG";
  case	0x006E:	return "EXEC";
  case	0x006F:	return "CHAR";
  case	0x0070:	return "LOWER";
  case	0x0071:	return "UPPER";
  case	0x0072:	return "PROPER";
  case	0x0073:	return "LEFT";
  case	0x0074:	return "RIGHT";
  case	0x0075:	return "EXACT";
  case	0x0076:	return "TRIM";
  case	0x0077:	return "REPLACE";
  case	0x0078:	return "SUBSTITUTE";
  case	0x0079:	return "CODE";
  case	0x007A:	return "NAMES";
  case	0x007B:	return "DIRECTORY";
  case	0x007C:	return "FIND";
  case	0x007D:	return "CELL";
  case	0x007E:	return "ISERR";
  case	0x007F:	return "ISTEXT";
  case	0x0080:	return "ISNUMBER";
  case	0x0081:	return "ISBLANK";
  case	0x0082:	return "T";
  case	0x0083:	return "N";
  case	0x0084:	return "FOPEN";
  case	0x0085:	return "FCLOSE";
  case	0x0086:	return "FSIZE";
  case	0x0087:	return "FREADLN";
  case	0x0088:	return "FREAD";
  case	0x0089:	return "FWRITELN";
  case	0x008A:	return "FWRITE";
  case	0x008B:	return "FPOS";
  case	0x008C:	return "DATEVALUE";
  case	0x008D:	return "TIMEVALUE";
  case	0x008E:	return "SLN";
  case	0x008F:	return "SYD";
  ...
  case	0x00A2:	return "CLEAN";
  case	0x00A3:	return "MDETERM";
  case	0x00A4:	return "MINVERSE";
  case	0x00A5:	return "MMULT";
  ...
  case	0x00AC:	return "WHILE";
  case	0x00AD:	return "BREAK";
  case	0x00AE:	return "NEXT";
  case	0x00AF:	return "INITIATE";
  case	0x00B0:	return "REQUEST";
  case	0x00B1:	return "POKE";
  case	0x00B2:	return "EXECUTE";
  case	0x00B3:	return "TERMINATE";
  case	0x00B4:	return "RESTART";
  case	0x00B5:	return "HELP";
  case	0x00B6:	return "GET.BAR";
  case	0x00B7:	return "PRODUCT";
  case	0x00B8:	return "FACT";
  case	0x00B9:	return "GET.CELL";
  case	0x00BA:	return "GET.WORKSPACE";
  case	0x00BB:	return "GET.WINDOW";
  case	0x00BC:	return "GET.DOCUMENT";
  case	0x00BD:	return "DPRODUCT";
  case	0x00BE:	return "ISNONTEXT";
  case	0x00BF:	return "GET.NOTE";
  case	0x00C0:	return "NOTE";
  case	0x00C1:	return "STDEVP";
  case	0x00C2:	return "VARP";
  case	0x00C3:	return "DSTDEVP";
  case	0x00C4:	return "DVARP";
  case	0x00C5:	return "TRUNC";
  case	0x00C6:	return "ISLOGICAL";
  case	0x00C7:	return "DCOUNTA";
  case	0x00C8:	return "DELETE.BAR";
  case	0x00C9:	return "UNREGISTER";
  case	0x00CC:	return "USDOLLAR";
  case	0x00CD:	return "FINDB";
  case	0x00CE:	return "SEARCHB";
  case	0x00CF:	return "REPLACEB";
  case	0x00D0:	return "LEFTB";
  case	0x00D1:	return "RIGHTB";
  case	0x00D2:	return "MIDB";
  case	0x00D3:	return "LENB";
  case	0x00D4:	return "ROUNDUP";
  case	0x00D5:	return "ROUNDDOWN";
  case	0x00D6:	return "ASC";
  case	0x00D7:	return "DBCS";
  ...
  case	0x00E0:	return "ELSE.IF";
  case	0x00E1:	return "END.IF";
  case	0x00E2:	return "FOR.CELL";
  case	0x00E3:	return "MEDIAN";
  case	0x00E4:	return "SUMPRODUCT";
  case	0x00E5:	return "SINH";
  case	0x00E6:	return "COSH";
  case	0x00E7:	return "TANH";
  case	0x00E8:	return "ASINH";
  case	0x00E9:	return "ACOSH";
  case	0x00EA:	return "ATANH";
  case	0x00EB:	return "DGET";
  ...
  case	0x00FE:	return "DELETE.TOOLBAR";
  case	0x00FF:	return "User Defined Function";
  case	0x0100:	return "RESET.TOOLBAR";
  case	0x0101:	return "EVALUATE";
  case	0x0102:	return "GET.TOOLBAR";
  case	0x0103:	return "GET.TOOL";
  case	0x0104:	return "SPELLING.CHECK";
  case	0x0105:	return "ERROR.TYPE";
  case	0x0106:	return "APP.TITLE";
  case	0x0107:	return "WINDOW.TITLE";
  case	0x0108:	return "SAVE.TOOLBAR";
  case	0x0109:	return "ENABLE.TOOL";
  case	0x010A:	return "PRESS.TOOL";
  case	0x010B:	return "REGISTER.ID";
  case	0x010C:	return "GET.WORKBOOK";
  case	0x010D:	return "AVEDEV";
  case	0x010E:	return "BETADIST";
  case	0x010F:	return "GAMMALN";
  case	0x0110:	return "BETAINV";
  case	0x0111:	return "BINOMDIST";
  case	0x0112:	return "CHIDIST";
  case	0x0113:	return "CHIINV";
  case	0x0114:	return "COMBIN";
  case	0x0115:	return "CONFIDENCE";
  case	0x0116:	return "CRITBINOM";
  case	0x0117:	return "EVEN";
  case	0x0118:	return "EXPONDIST";
  case	0x0119:	return "FDIST";
  case	0x011A:	return "FINV";
  case	0x011B:	return "FISHER";
  case	0x011C:	return "FISHERINV";
  case	0x011D:	return "FLOOR";
  case	0x011E:	return "GAMMADIST";
  case	0x011F:	return "GAMMAINV";
  case	0x0120:	return "CEILING";
  case	0x0121:	return "HYPGEOMDIST";
  case	0x0122:	return "LOGNORMDIST";
  case	0x0123:	return "LOGINV";
  case	0x0124:	return "NEGBINOMDIST";
  case	0x0125:	return "NORMDIST";
  case	0x0126:	return "NORMSDIST";
  case	0x0127:	return "NORMINV";
  case	0x0128:	return "NORMSINV";
  case	0x0129:	return "STANDARDIZE";
  case	0x012A:	return "ODD";
  case	0x012B:	return "PERMUT";
  case	0x012C:	return "POISSON";
  case	0x012D:	return "TDIST";
  case	0x012E:	return "WEIBULL";
  case	0x012F:	return "SUMXMY2";
  case	0x0130:	return "SUMX2MY2";
  case	0x0131:	return "SUMX2PY2";
  case	0x0132:	return "CHITEST";
  case	0x0133:	return "CORREL";
  case	0x0134:	return "COVAR";
  case	0x0135:	return "FORECAST";
  case	0x0136:	return "FTEST";
  case	0x0137:	return "INTERCEPT";
  case	0x0138:	return "PEARSON";
  case	0x0139:	return "RSQ";
  case	0x013A:	return "STEYX";
  case	0x013B:	return "SLOPE";
  case	0x013C:	return "TTEST";
  ...
  case	0x0145:	return "LARGE";
  case	0x0146:	return "SMALL";
  case	0x0147:	return "QUARTILE";
  case	0x0148:	return "PERCENTILE";
  case	0x0149:	return "PERCENTRANK";
  case	0x014A:	return "MODE";
  case	0x014B:	return "TRIMMEAN";
  case	0x014C:	return "TINV";
  case	0x014E:	return "MOVIE.COMMAND";
  case	0x014F:	return "GET.MOVIE";
  case	0x0150:	return "CONCATENATE";
  case	0x0151:	return "POWER";
  ...
  case	0x0156:	return "RADIANS";
  case	0x0157:	return "DEGREES";
  case	0x0158:	return "SUBTOTAL";
  case	0x0159:	return "SUMIF";
  case	0x015A:	return "COUNTIF";
  case	0x015B:	return "COUNTBLANK";
  case	0x015C:	return "SCENARIO.GET";
  case	0x015D:	return "OPTIONS.LISTS.GET";
  case	0x015E:	return "ISPMT";
  case	0x015F:	return "DATEDIF";
  case	0x0160:	return "DATESTRING";
  case	0x0161:	return "NUMBERSTRING";
  ...
  case	0x0170:	return "BAHTTEXT";
  case	0x0171:	return "THAIDAYOFWEEK";
  case	0x0172:	return "THAIDIGIT";
  case	0x0173:	return "THAIMONTHOFYEAR";
  case	0x0174:	return "THAINUMSOUND";
  case	0x0175:	return "THAINUMSTRING";
  case	0x0176:	return "THAISTRINGLENGTH";
  case	0x0177:	return "ISTHAIDIGIT";
  case	0x0178:	return "ROUNDBAHTDOWN";
  case	0x0179:	return "ROUNDBAHTUP";
  case	0x017A:	return "THAIYEAR";
