    ...
    while (!end_of_style_sheet) {
      ...
      switch (x) {
        ...
        case BrtFont: {
          ...
          FontFlagsFields view_flags = openxlsx2::bit_cast<FontFlagsFields>(grbit);
        ...
        case BrtXF: {
          ...
          XFFields view_flags = openxlsx2::bit_cast<XFFields>(brtxf);

          uint8_t xfgbit = view_flags.xfGrbitAtr;

          xfGrbitAtrFields view_flags2 = openxlsx2::bit_cast<xfGrbitAtrFields>(xfgbit);
    ...
    while (!end_of_table) {
      ...
      switch (x) {
        ...
        case BrtTableStyleClient: {
          ...
          BrtTableStyleClientFields view_flags = openxlsx2::bit_cast<BrtTableStyleClientFields>(flags);
    ...
    while (!end_of_workbook) {
      ...
      switch (x) {
        ...
        case BrtWbProp: {
          ...
          BrtWbPropFields view_flags = openxlsx2::bit_cast<BrtWbPropFields>(flags);
        ...
        case BrtUserBookView: {
          ...
          BrtUserBookViewFields view_flags = openxlsx2::bit_cast<BrtUserBookViewFields>(flags);
        ...
        case BrtName: {
          ...
          BrtNameFields view_flags = openxlsx2::bit_cast<BrtNameFields>(BrtNameUint);
          BrtNameFields2 view_flags2 = openxlsx2::bit_cast<BrtNameFields2>(BrtNameUint2);
          ...
          if (debug)
            Rprintf(
              ...
              view_flags.fBuiltin,
              view_flags.fgrp,
              view_flags.fPublished,
              view_flags2.fWorkbookParam,
              view_flags2.fFutureFunction,
              view_flags2.reserved
            );
    ...
    while (!end_of_worksheet) {
      ...
      switch(x) {
        ...
        case BrtBeginWsView: {
          ...
          BrtBeginWsViewFields view_flags = openxlsx2::bit_cast<BrtBeginWsViewFields>(flags);
        ...
        case BrtBeginHeaderFooter: {
          ...
          BrtBeginHeaderFooterFields view_flags = openxlsx2::bit_cast<BrtBeginHeaderFooterFields>(flags);
        ...
        case BrtColInfo: {
          ...
          BrtColInfoFields view_flags = openxlsx2::bit_cast<BrtColInfoFields>(colinfo);
        ...
        case BrtRowHdr: {
          ...
          BrtRowHdrFields view_flags = openxlsx2::bit_cast<BrtRowHdrFields>(rwoheaderfields);
        ...
        case BrtFmlaBool: {
          ...
          GrbitFmlaFields view_flags = openxlsx2::bit_cast<GrbitFmlaFields>(grbitFlags);
        ...
        case BrtBeginUserShView: {
          ...
          BrtBeginUserShViewFields view_flags = openxlsx2::bit_cast<BrtBeginUserShViewFields>(flags);
        ...
        case BrtDVal: {
          ...
          BrtDValFields view_flags = openxlsx2::bit_cast<BrtDValFields>(flags);
        ...
        case BrtDVal14: {
          ...
          Rprintf("%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",
            (uint32_t)view_flags.valType,
            (uint32_t)view_flags.errStyle,
            (uint32_t)view_flags.unused,
            (uint32_t)view_flags.fAllowBlank,
            (uint32_t)view_flags.fSuppressCombo,
            (uint32_t)view_flags.mdImeMode,
            (uint32_t)view_flags.fShowInputMsg,
            (uint32_t)view_flags.fShowErrorMsg,
            (uint32_t)view_flags.typOperator,
            (uint32_t)view_flags.fDVMinFmla,
            (uint32_t)view_flags.fDVMaxFmla
          );
        ...
        case BrtBeginCFRule: {
          ...
          BrtBeginCFRuleFields view_flags = openxlsx2::bit_cast<BrtBeginCFRuleFields>(flags);
