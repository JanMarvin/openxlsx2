  ...
  if (bin) {
    ...
    while (!end_of_style_sheet) {
      ...
      case BrtFont: {
        ...
        if (color[0] == 0x02) {
          out << "<color rgb=\"" << to_argb(color[6], color[3], color[4], color[5]) << "\" />"
              << std::endl;
        }
      ...
      case BrtFill: {
        ...
        double   xnumDegree = 0.0, xnumFillToLeft = 0.0, xnumFillToRight = 0.0, xnumFillToTop = 0.0,
        ...
        if (debug) {
          Rcpp::Rcout << "unused gradinet filll colors" << xnumDegree << ": " << xnumFillToLeft
        ...
        for (uint32_t i = 0; i < cNumStop; ++i) {
          ...
          if (debug) {
            Rcpp::Rcout << "unused gradient Colors: "
                        << to_argb(fgColor[6], fgColor[3], fgColor[4], fgColor[5]) << ": " << aPos
                        << std::endl;
          }
        }
      ...
      case BrtXF: {
        ...
        if (
          fields->alc > 0 || fields->alcv > 0 || indent || trot || fields->iReadingOrder ||
          fields->fShrinkToFit || fields->fWrap || fields->fJustLast) {
          out << "><alignment";
      ...
      case BrtIndexedColor: {
        ...
        // if (color[0] == 0x02) {
        out << "<rgbColor rgb=\"" << to_argb(reserved, bRed, bGreen, bRed) << std::dec << "\" />"
            << std::endl;
        // }
        break;
      }
  ...
  if (bin) {
    ...
    while (!end_of_table) {
      ...
      case BrtBeginList: {
        ...
        std::string ref = int_to_col(rfxList[2] + 1) + std::to_string(rfxList[0] + 1) + ":" +
        ...
        uint32_t nDxfHeader = 0, nDxfData = 0, nDxfAgg = 0, nDxfBorder = 0, nDxfHeaderBorder = 0,
                 nDxfAggBorder = 0, dwConnID = 0;
        ...
        out << "<table "
               ...
               "2014/revision\" "
               "xmlns:xr3=\"http://schemas.microsoft.com/office/spreadsheetml/"
               "2016/revision3\" mc:Ignorable=\"xr xr3\""
            << " id=\"" << idList << "\" name=\"" << stName << "\" displayName=\"" << stDisplayName
            << "\" ref=\"" << ref << "\" totalsRowShown=\"" << crwTotals << "\">" << std::endl;
      ...
      case BrtColorFilter: {
        ...
        out << "<colorFilter dxfId=\"" << dxfid << "\" cellColor=\"" << fCellColor << "\"/>"
            << std::endl;
      ...
      case BrtBeginListCol: {
        ...
        std::string stStyleAgg       = XLNullableWideString(bin, swapit);
        if (debug)
          Rcpp::Rcout << stStyleHeader << ": " << stStyleInsertRow << ": " << stStyleAgg
                      << std::endl;
      ...
      case BrtTableStyleClient: {
        ...
        // out <<" showColHeaders=\"" << fields->fColumnHeaders << "\""; // not
      ...
      default: {
        if (debug) {
          Rcpp::Rcout << std::to_string(x) << ": " << std::to_string(size) << " @ " << bin.tellg()
                      << std::endl;
        }
        bin.seekg(size, bin.cur);
        break;
  ...
  if (bin) {
    ...
    while (!end_of_comments) {
      ...
      case BrtCommentText: {
        ...
        // out << "<text><r><rPr><sz val=\"10\"/><color rgb=\"FF000000\"/><rFont
        // val=\"Tahoma\"/><family val=\"2\"/></rPr><t>" <<
        // escape_xml(commentText) << "</t></r></text>" << std::endl;
    ...
    while (!end_of_external_reference) {
      ...
      case BrtBeginSupBook: {
        ...
        out << "<externalLink "
               ...
               "xmlns:mc=\"http://schemas.openxmlformats.org/"
               "markup-compatibility/2006\" "
               "xmlns:x14=\"http://schemas.microsoft.com/office/spreadsheetml/"
               "2009/9/main\" "
      ...
      default: {
        ...
        Rcpp::Rcout << "Unhandled ER: " << std::to_string(x) << ": " << std::to_string(size)
                    << " @ " << bin.tellg() << std::endl;
        // }
        bin.seekg(size, bin.cur);
        break;
  ...
  if (bin) {
    ...
    while (!end_of_shared_strings) {
      ...
      case BrtBeginSst: {
        ...
        out << "<sst " << "count=\"" << count << "\" uniqueCount=\"" << uniqueCount << "\">"
            << std::endl;
        break;
      }
    ...
    while (!end_of_workbook) {
      ...
      case BrtBeginBook: {
        ...
        out << "<workbook "
               ...
               "xmlns:xr=\"http://schemas.microsoft.com/office/spreadsheetml/"
               "2014/revision\" "
               "xmlns:xr6=\"http://schemas.microsoft.com/office/spreadsheetml/"
               "2016/revision6\" "
               "xmlns:xr10=\"http://schemas.microsoft.com/office/spreadsheetml/"
               "2016/revision10\" "
               "xmlns:xr2=\"http://schemas.microsoft.com/office/spreadsheetml/"
               "2015/revision2\" mc:Ignorable=\"x15 xr xr6 xr10 xr2\">"
            << std::endl;
        bin.seekg(size, bin.cur);
        break;
      }
      ...
      case BrtWbProp: {
        ...
        out << "<workbookPr" <<
          ...
          " autoCompressPictures=\"" << fields->fAutoCompressPictures << "\" "
            ...
            << " codeName=\"" << strName << "\" " << " date1904=\"" << fields->f1904 << "\" "
      ...
      case BrtBookView: {
        ...
        out << "<workbookView xWindow=\"" << xWn << "\" yWindow=\"" << yWn << "\" windowWidth=\""
            << dxWn << "\" windowHeight=\"" << dyWn << "\" activeTab=\"" << itabCur << "\" />"
            << std::endl;
        break;
      }
      ...
      case BrtUserBookView: {
        ...
        int32_t xLeft = 0, xRight = 0, yTop = 0, yBot = 0, iTabid = 0, iTabRatio = 0, guid0 = 0,
                guid1 = 0, guid2 = 0, guid3 = 0, flags = 0;
        ...
        if (fields->fTimedUpdate)
          cwv << " autoUpdate=\"" << fields->fTimedUpdate << "\"" << std::endl;
        if (fields->fTimedUpdate)
          cwv << " mergeInterval=\"" << wMergeInterval << "\"" << std::endl;
        if (fields->fAllMemChanges)
          cwv << " changesSavedWin=\"" << fields->fAllMemChanges << "\"" << std::endl;
        if (fields->fOnlySync)
          cwv << " onlySync=\"" << fields->fOnlySync << "\"" << std::endl;
        if (fields->fPersonalView)
          cwv << " personalView=\"" << fields->fPersonalView << "\"" << std::endl;
        if (!fields->fPrintIncl)
          cwv << " includePrintSettings=\"" << fields->fPrintIncl << "\"" << std::endl;
        // wrong?
        ...
        if (!fields->fDspHScroll)
          cwv << " showHorizontalScroll=\"" << fields->fDspHScroll << "\"" << std::endl;
        if (!fields->fDspVScroll)
          cwv << " showVerticalScroll=\"" << fields->fDspVScroll << "\"" << std::endl;
        if (!fields->fBotAdornment)
          cwv << " showSheetTabs=\"" << fields->fBotAdornment << "\"" << std::endl;
        if (xLeft > 0)
        ...
        if (!fields->fDspFmlaBar)
          cwv << " showFormulaBar=\"" << fields->fDspFmlaBar << "\"" << std::endl;
        if (!fields->fDspStatus)
          cwv << " showStatusbar=\"" << fields->fDspStatus << "\"" << std::endl;
      ...
      case BrtBundleSh: {
        ...
        out << "<sheet r:id=\"" << rid << "\" state=\"" << visible << "\" sheetId=\"" << iTabID
            << "\" name=\"" << val << "\"/>" << std::endl;
        break;
      }
      ...
      case BrtExternSheet: {
        ...
        for (uint32_t i = 0; i < cXti; ++i) {
          ...
          std::string tmp = "<xti id=\"" + std::to_string(xti[0]) + "\" firstSheet=\"" +
                            std::to_string(xti[1]) + "\" lastSheet=\"" + std::to_string(xti[2]) +
      ...
      if (debug)
        Rcpp::Rcout << "wb-loop: " << x << ": " << size << ": " << bin.tellg() << std::endl;
    }
    ...
    while (!end_of_worksheet) {
      ...
      case BrtCsProp: {
        ...
        if (color[0] >= 1 && color[0] <= 3) {
          ...
          if (color[0] == 0x02) {
            out << "<tabColor rgb=\"" << to_argb(color[6], color[3], color[4], color[5]) << "\" />"
                << std::endl;
          }
      ...
      case BrtBeginWsView: {
        ...
        uint16_t flags = 0, reserved3 = 0, wScale = 0, wScaleNormal = 0, wScaleSLV = 0,
                 wScalePLV = 0;
      ...
      case BrtPageSetup: {
        ...
        uint16_t flags      = 0;
        uint32_t iPaperSize = 0, iScale = 0, iRes = 0, iVRes = 0, iCopies = 0, iPageStart = 0,
                 iFitWidth = 0, iFitHeight = 0;
        ...
        out << "<pageSetup" <<
          ...
          " copies=\"" << iCopies <<
          // "\" errors=\""<<  <<
          "\" firstPageNumber=\"" << iPageStart << "\" fitToHeight=\"" << iFitHeight
            << "\" fitToWidth=\"" << iFitWidth << "\" horizontalDpi=\"" << iRes <<
          // "\" orientation=\""<<  <<
          // "\" pageOrder=\""<<  <<
          // "\" paperHeight=\""<<  <<
      ...
      case BrtBeginHeaderFooter: {
        ...
        if (debug)
          Rcpp::Rcout << stHeader << ": " << stFooter << ": " << stHeaderEven << ": "
                      << stFooterEven << ": " << stHeaderFirst << ": " << stFooterFirst
                      << std::endl;

        out << "<headerFooter" << std::endl;
        if (fields->fHFDiffOddEven)
          out << " differentOddEven=\"" << fields->fHFDiffOddEven << "\"" << std::endl;
        if (fields->fHFDiffFirst)
          out << " differentFirst=\"" << fields->fHFDiffFirst << "\"" << std::endl;
        if (fields->fHFScaleWithDoc)
          out << " scaleWithDoc=\"" << fields->fHFScaleWithDoc << "\"" << std::endl;
        if (fields->fHFAlignMargins)
          out << " alignWithMargins=\"" << fields->fHFAlignMargins << "\"" << std::endl;
        out << ">" << std::endl;
        ...
        if (!stHeaderEven.empty())
          out << "<evenHeader>" << stHeaderEven << "</evenHeader>" << std::endl;
        if (!stFooterEven.empty())
          out << "<evenFooter>" << stFooterEven << "</evenFooter>" << std::endl;
        if (!stHeaderFirst.empty())
          out << "<firstHeader>" << stHeaderFirst << "</firstHeader>" << std::endl;
        if (!stFooterFirst.empty())
          out << "<firstFooter>" << stFooterFirst << "</firstFooter>" << std::endl;
        out << "</headerFooter>" << std::endl;
      ...
      case BrtSel: {
        ...
        out << "<selection pane=\"" << spnn << "\" activeCell=\"" << ac << "\" sqref=\"" << sqref
            << "\" />" << std::endl;
      ...
      case BrtRowHdr: {
        ...
        if (!first_row) {
          ...
          for (size_t i = 0; i < colvec.size(); ++i) {
            out << "<c r=\"" << colvec[i].c_r << "\" s=\"" << colvec[i].c_s << "\" t=\""
                << colvec[i].c_t << "\">" << std::endl;
            out << "<v>" << escape_xml(colvec[i].v) << "</v>" << std::endl;
            out << "<f ref=\"" << colvec[i].f_ref << "\" ca=\"" << colvec[i].f_ca << "\" si=\""
                << colvec[i].f_si << "\" t=\"" << colvec[i].f_t << "\" >" << colvec[i].f << "</f>"
                << std::endl;
            out << "</c>" << std::endl;
          }
        ...
        uint8_t bits3 = 0, fExtraAsc = 0, fExtraDsc = 0, fCollapsed = 0, fDyZero = 0, fUnsynced = 0,
                fGhostDirty = 0, fReserved = 0, fPhShow = 0;
        uint16_t miyRw = 0;
        ...
        if (ccolspan) {
          ...
          // value. there are other types of spans (1:1 1024:16384), but unsure
          // how this is supposed to be handled. It's possible to have elements
          // like spans = "1:1 16384:16384" which we will read as spans =
          // "1:16384"
        ...
        if (debug)
          Rcpp::Rcout << "ROW:" << (rw + 1) << " : " << ixfe << " : " << miyRw << " : "
                      << (int32_t)fExtraAsc << " : " << (int32_t)fExtraDsc << " : " << unk32
                      << " : " << (int32_t)fCollapsed << " : " << (int32_t)fDyZero << " : "
                      << (int32_t)fUnsynced << " : " << (int32_t)fGhostDirty << " : "
                      << (int32_t)fReserved << " : " << (int32_t)fPhShow << " : " << ccolspan
                      << "; " << bin.tellg() << std::endl;
      ...
      case BrtCellReal: {
        ...
        // out << "<c r=\"" << int_to_col(val1 + 1) << row + 1 << "\"" <<
        // cell_style(val2) << ">" << std::endl; out << "<v>" <<
        // std::setprecision(16) << dbl << "</v>" << std::endl; // << std::fixed
        // out << "</c>" << std::endl;
      ...
      case BrtCellError: { // t="e" & <v>#NUM!</v>
        ...
        // BErr(bin, swapit) << "</v>" << std::endl; out << "</c>" << std::endl;
      ...
      case BrtCellMeta: {
        ...
        if (debug)
          Rcpp::Rcout << "cell contains unhandled cell metadata entry" << icmb << std::endl;
      ...
      case BrtFmlaBool: {
        ...
        // GrbitFmlaFields *fields = (GrbitFmlaFields *)&grbitFlags;
        std::string fml =
          CellParsedFormula(bin, swapit, debug, 0, row, is_shared_formula, has_revision_record);
      ...
      case BrtArrFmla: {
        ...
        std::string fml =
          CellParsedFormula(bin, swapit, debug, col, row, is_shared_formula, has_revision_record);
        if (debug)
      ...
      case BrtMergeCell: {
        ...
        out << "<mergeCell ref=\"" << int_to_col(colFirst) << rwFirst << ":" << int_to_col(colLast)
            << rwLast << "\" />" << std::endl;
      ...
      case BrtMargins: {
        ...
        double xnumLeft = 0, xnumRight = 0, xnumTop = 0, xnumBottom = 0, xnumHeader = 0,
               xnumFooter = 0;
        ...
        out << "<pageMargins" << " left=\"" << xnumLeft << "\"" << " right=\"" << xnumRight << "\""
            << " top=\"" << xnumTop << "\"" << " bottom=\"" << xnumBottom << "\""
            << " header=\"" << xnumHeader << "\""
            << " footer=\"" << xnumFooter << "\"" << " />" << std::endl;
      ...
      case BrtHLink: {
        ...
        std::string hlink = "<hyperlink display=\"" + escape_xml(display) + "\" r:id=\"" + relId +
                            "\" location=\"" + escape_xml(location) + "\" ref=\"" + ref +
      ...
      case BrtOleObject: {
        ...
        if (fLinked)
          std::string link =
            CellParsedFormula(bin, swapit, debug, 0, 0, sharedFormula, has_revision_record);

        std::string stRelID = XLNullableWideString(bin, swapit);
        out << "<oleObject progId=\"" << strProgID << "\" shapeId=\"" << shapeId << "\" r:id=\""
            << stRelID << "\" />" << std::endl;
        break;
      }
      ...
      case BrtDVal: {
        ...
        out << "<dataValidation " << "type=\"" << valType(fields->valType) << "\" "
            << "operator=\"" << typOperator(fields->typOperator) << "\" " << "allowBlank=\""
            << (bool)fields->fAllowBlank << "\" "
            << "showInputMessage=\"" << (bool)fields->fShowInputMsg << "\" "
            << "showErrorMessage=\"" << (bool)fields->fShowErrorMsg << "\" "
            << "sqref=\"" << sqref << "\" >" << "<formula1>" << formula1 << "</formula1>"
      ...
      case BrtDVal14: {
        ...
        if (fields_frt->fFormula) { // 0 or 1
          ...
          for (uint32_t cfml = 0; cfml < cformula; ++cfml) {
            ...
            int32_t     sharedFormula = false;
            std::string frt_fml =
              FRTParsedFormula(bin, swapit, debug, 0, 0, sharedFormula, has_revision_record);
        ...
        for (size_t len = 0; len < frt_fmls.size(); ++len) {
          ...
          out << "<x14:formula" << std::to_string(len + 1) << ">" << "<xm:f>" << frt_fmls[len]
              << "</xm:f>"
      ...
      case BrtBeginCFRule: {
        ...
        uint16_t flags = 0;
        uint32_t iType = 0, iTemplate = 0, dxfId = 0, iPri = 0, iParam = 0, reserved1 = 0,
                 reserved2 = 0;
      ...
      default: {
        // if (debug) {
        Rcpp::Rcout << "Unhandled: " << std::to_string(x) << ": " << std::to_string(size) << " @ "
                    << bin.tellg() << std::endl;
        // }
        bin.seekg(size, bin.cur);
        break;
