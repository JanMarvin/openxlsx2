...
test_that("test add_fill()", {
  ...
  wb <- wb_workbook()
  wb$add_worksheet("S1")$add_data("S1", mtcars)
  expect_silent(wb$add_fill("S1", dims = "D5:G6", color = wb_color(hex = "FFFFFF00")))
  ...
  wb$add_fill("S1", dims = "A1:E6", color = wb_color(hex = "FFFFFF00"), every_nth_col = 2)
  wb$add_fill("S1", dims = "A1:E6", color = wb_color(hex = "FF00FF00"), every_nth_row = 2)
  ...
  wb <- wb_workbook()
  wb$add_worksheet("S1")$add_fill("S1", dims = "D5:G6", color = wb_color(hex = "FFFFFF00"))
...
test_that("test add_font()", {
  ...
  wb <- wb_workbook()
  wb$add_worksheet("S1")$add_data("S1", mtcars)
  expect_silent(wb$add_font("S1", dims = "A1:K1", color = wb_color(hex = "FFFFFF00")))
  ...
  wb <- wb_workbook()
  wb$add_worksheet("S1")$add_font("S1", dims = "A1:K1", color = wb_color(hex = "FFFFFF00"))
