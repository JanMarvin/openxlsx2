...
test_that("comments", {
  ...
  expect_warning(c2 <- create_comment(text = "this is another comment", author = "Marco Polo"), "deprecated")
  ...
  expect_warning(c3 <- create_comment(text = c("This Part Bold red\n\n", "This part black"), style = c(s1, s2)), "deprecated")
  ...
  # write comment without author
  expect_warning(c1 <- create_comment(text = "this is a comment", author = "", visible = FALSE), "deprecated")
...
test_that("print comment", {
  ...
  expect_warning(c2 <- create_comment(text = "this is another comment",
                       author = "Marco Polo"), "deprecated")
