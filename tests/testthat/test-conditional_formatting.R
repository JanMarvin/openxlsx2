test_that("conditional formatting", {
  ...
  wb$add_conditional_formatting("between", cols = 1, rows = 1:11, type = "between", rule = c(-2, 2))
  ...
  wb$add_conditional_formatting("topN", cols = 1, rows = 2:11,
  ...
  wb$add_conditional_formatting("bottomN", cols = 1, rows = 2:11,
