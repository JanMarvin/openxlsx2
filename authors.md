...
- **Jordan Mark Barbone**. Author.
  [](https://orcid.org/0000-0001-9788-3628)

- **Jan Marvin Garbuszus**. Author, maintainer.
...
- **Arseny Kapoulkine**. Contributor, copyright holder.  
  Author of included pugixml code

## Citation

Source:
[`inst/CITATION`](https://github.com/JanMarvin/openxlsx2/blob/v1.25/inst/CITATION)

(2026). openxlsx2: Read, Write and Edit 'xlsx' Files. R package version
1.25. URL https://github.com/JanMarvin/openxlsx2.
