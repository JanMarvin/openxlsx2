...
- [`wb_add_encharter()`](https://janmarvin.github.io/openxlsx2/reference/wb_add_encharter.md)
...
- [`print(`*`<pugi_xml>`*`)`](https://janmarvin.github.io/openxlsx2/reference/print.pugi_xml.md)
  : print pugi_xml
- [`as.character(`*`<pugi_xml>`*`)`](https://janmarvin.github.io/openxlsx2/reference/as.character.pugi_xml.md)
