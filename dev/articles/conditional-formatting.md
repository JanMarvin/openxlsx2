...
![Basic conditional formatting](img/cf_cells.jpg)
...
![Moving row conditional formatting](img/cf_moving_row.jpg)
...
![Moving column conditional formatting](img/cf_moving_col.jpg)
...
![Dependent conditional formatting](img/cf_dependent_on.jpg)
...
![Duplicated conditional formatting](img/cf_duplicates.jpg)
...
![Contains text conditional formatting](img/cf_contains_text.jpg)
...
![Not contains text conditional formatting](img/cf_contains_no_text.jpg)
...
![Begins with conditional formatting](img/cf_begins_with.jpg)
...
![Ends with conditional formatting](img/cf_ends_with.jpg)
...
![Colorscale conditional formatting (\_Yep, that is a color scale
image\_)](img/cf_color_scale.jpg)
...
[`colors()`](https://rdrr.io/r/grDevices/colors.html)). If rule is
`NULL`, min and max of cells is used. Rule must be the same length as
style or L.
...
![Databar conditional formatting](img/cf_databar.jpg)
...
![Between conditional formatting](img/cf_between.jpg)

Between conditional formatting
...
![Top n conditional formatting](img/cf_top_n.jpg)
...
![Bottom n conditional formatting](img/cf_bottom_n.jpg)
...
#> Warning in wb$add_conditional_formatting("bottomN", cols = 2, rows = 2:11, : 'cols/rows' is deprecated.
#> Use 'dims' instead.
...
formatting](img/cf_logical_operators.jpg)
