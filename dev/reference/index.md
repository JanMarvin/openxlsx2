...
- [`wb_set_col_widths()`](https://janmarvin.github.io/openxlsx2/dev/reference/col_widths-wb.md)
  [`wb_remove_col_widths()`](https://janmarvin.github.io/openxlsx2/dev/reference/col_widths-wb.md)
  : Modify column widths of a worksheet
- [`wb_add_filter()`](https://janmarvin.github.io/openxlsx2/dev/reference/filter-wb.md)
  [`wb_remove_filter()`](https://janmarvin.github.io/openxlsx2/dev/reference/filter-wb.md)
  : Add/remove column filters in a worksheet
- [`wb_group_cols()`](https://janmarvin.github.io/openxlsx2/dev/reference/grouping-wb.md)
  [`wb_ungroup_cols()`](https://janmarvin.github.io/openxlsx2/dev/reference/grouping-wb.md)
  [`wb_group_rows()`](https://janmarvin.github.io/openxlsx2/dev/reference/grouping-wb.md)
  [`wb_ungroup_rows()`](https://janmarvin.github.io/openxlsx2/dev/reference/grouping-wb.md)
...
- [`wb_set_row_heights()`](https://janmarvin.github.io/openxlsx2/dev/reference/row_heights-wb.md)
  [`wb_remove_row_heights()`](https://janmarvin.github.io/openxlsx2/dev/reference/row_heights-wb.md)
...
- [`wb_add_hyperlink()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_add_hyperlink.md)
  [`wb_remove_hyperlink()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_add_hyperlink.md)
  : wb_add_hyperlink
...
- [`wb_add_slicer()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_add_slicer.md)
  [`wb_remove_slicer()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_add_slicer.md)
  [`wb_add_timeline()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_add_slicer.md)
  [`wb_remove_timeline()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_add_slicer.md)
  : Add a slicer/timeline to a pivot table
- [`wb_add_thread()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_add_thread.md)
  [`wb_get_thread()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_add_thread.md)
...
[`vignette("openxlsx2_charts_manual")`](https://janmarvin.github.io/openxlsx2/dev/articles/openxlsx2_charts_manual.md).
...
- [`wb_set_base_font()`](https://janmarvin.github.io/openxlsx2/dev/reference/base_font-wb.md)
  [`wb_get_base_font()`](https://janmarvin.github.io/openxlsx2/dev/reference/base_font-wb.md)
...
- [`wb_get_properties()`](https://janmarvin.github.io/openxlsx2/dev/reference/properties-wb.md)
...
- [`wb_add_creators()`](https://janmarvin.github.io/openxlsx2/dev/reference/creators-wb.md)
  [`wb_set_creators()`](https://janmarvin.github.io/openxlsx2/dev/reference/creators-wb.md)
  [`wb_remove_creators()`](https://janmarvin.github.io/openxlsx2/dev/reference/creators-wb.md)
  [`wb_get_creators()`](https://janmarvin.github.io/openxlsx2/dev/reference/creators-wb.md)
  : Modify creators of a workbook
- [`wb_get_order()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_order.md)
...
- [`wb_remove_worksheet()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_remove_worksheet.md)
...
- [`wb_get_sheet_visibility()`](https://janmarvin.github.io/openxlsx2/dev/reference/sheet_visibility-wb.md)
  [`wb_set_sheet_visibility()`](https://janmarvin.github.io/openxlsx2/dev/reference/sheet_visibility-wb.md)
...
- [`wb_get_bookview()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_set_bookview.md)
  ...
  [`wb_set_bookview()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_set_bookview.md)
  : Get and Set the workbook position, size and filter
- [`wb_add_person()`](https://janmarvin.github.io/openxlsx2/dev/reference/person-wb.md)
  [`wb_get_person()`](https://janmarvin.github.io/openxlsx2/dev/reference/person-wb.md)
...
- [`wb_add_comment()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_add_comment.md)
  [`wb_get_comment()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_add_comment.md)
...
- [`wb_add_data_validation()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_add_data_validation.md)
...
- [`wb_add_page_break()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_add_page_break.md)
  : Add a page break to a worksheet
- [`wb_add_mips()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_add_mips.md)
  [`wb_get_mips()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_add_mips.md)
...
- [`wb_set_sheetview()`](https://janmarvin.github.io/openxlsx2/dev/reference/wb_set_sheetview.md)
...
- [`read_xml()`](https://janmarvin.github.io/openxlsx2/dev/reference/read_xml.md)
  : read xml file
- [`xml_node()`](https://janmarvin.github.io/openxlsx2/dev/reference/pugixml.md)
  [`xml_node_name()`](https://janmarvin.github.io/openxlsx2/dev/reference/pugixml.md)
  [`xml_value()`](https://janmarvin.github.io/openxlsx2/dev/reference/pugixml.md)
  [`xml_attr()`](https://janmarvin.github.io/openxlsx2/dev/reference/pugixml.md)
  : xml_node
- [`xml_add_child()`](https://janmarvin.github.io/openxlsx2/dev/reference/xml_add_child.md)
...
- [`xml_node_create()`](https://janmarvin.github.io/openxlsx2/dev/reference/xml_node_create.md)
...
- [`as_xml()`](https://janmarvin.github.io/openxlsx2/dev/reference/as_xml.md)
...
- [`print(`*`<pugi_xml>`*`)`](https://janmarvin.github.io/openxlsx2/dev/reference/print.pugi_xml.md)
  : print pugi_xml
- [`as.character(`*`<pugi_xml>`*`)`](https://janmarvin.github.io/openxlsx2/dev/reference/as.character.pugi_xml.md)
  : as.character pugi_xml

### Other helpers

- [`int2col()`](https://janmarvin.github.io/openxlsx2/dev/reference/int2col.md)
...
- [`fmt_txt()`](https://janmarvin.github.io/openxlsx2/dev/reference/fmt_txt.md)
  [`` `+`( ``*`<fmt_txt>`*`)`](https://janmarvin.github.io/openxlsx2/dev/reference/fmt_txt.md)
  [`as.character(`*`<fmt_txt>`*`)`](https://janmarvin.github.io/openxlsx2/dev/reference/fmt_txt.md)
  [`print(`*`<fmt_txt>`*`)`](https://janmarvin.github.io/openxlsx2/dev/reference/fmt_txt.md)
...
- [`styles_on_sheet()`](https://janmarvin.github.io/openxlsx2/dev/reference/styles_on_sheet.md)
  : Get all styles on a sheet

## Package introduction

- [`openxlsx2`](https://janmarvin.github.io/openxlsx2/dev/reference/openxlsx2-package.md)
  [`openxlsx2-package`](https://janmarvin.github.io/openxlsx2/dev/reference/openxlsx2-package.md)
  : xlsx reading, writing and editing.

## Package options

- [`openxlsx2_options`](https://janmarvin.github.io/openxlsx2/dev/reference/openxlsx2_options.md)
  : Options consulted by openxlsx2

## Deprecated

- [`openxlsx2-deprecated`](https://janmarvin.github.io/openxlsx2/dev/reference/openxlsx2-deprecated.md)
  :
