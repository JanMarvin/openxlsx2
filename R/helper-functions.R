...
#' @param file Hyperlink or xlsx file name to point to. If `NULL`, hyperlink is internal.
#' @examples
#' wb <- wb_workbook()$
...
# an empty vml drawing part for header and footer images. The pictures are
# appended as v:shape nodes, one per section of the header or the footer.
vml_hf_empty <- paste0(
  ...
  '<o:lock v:ext="edit" aspectratio="t"/></v:shapetype></xml>'
)
