...
#' @importFrom stringi stri_c stri_conv stri_isempty stri_join stri_match stri_match_all_regex stri_rand_strings stri_replace_all_fixed stri_split_fixed stri_split_regex stri_sub
