...
# wb <- wb_load("/tmp/bar1.xlsx")
# chart1_xml <- read_xml("/var/folders/p7/t9znbbgj2_ndlz6vbxmgh7zm0000gn/T//Rtmpcb7KoT/_openxlsx_wb_load2c2250c6506f/xl/charts/chart1.xml",
#                        pointer = FALSE)
# colors1_xml <- read_xml("/var/folders/p7/t9znbbgj2_ndlz6vbxmgh7zm0000gn/T//Rtmpcb7KoT/_openxlsx_wb_load2c2250c6506f/xl/charts/colors1.xml",
#                        pointer = FALSE)
# style1_xml <- read_xml("/var/folders/p7/t9znbbgj2_ndlz6vbxmgh7zm0000gn/T//Rtmpcb7KoT/_openxlsx_wb_load2c2250c6506f/xl/charts/style1.xml",
#                         pointer = FALSE)
# chart1_rels_xml <- read_xml("/var/folders/p7/t9znbbgj2_ndlz6vbxmgh7zm0000gn/T//Rtmpw2YYGv/_openxlsx_wb_load16c4b28deefd9/xl/charts/_rels/chart1.xml.rels",
#                        pointer = FALSE)


barchart_ser <- function(id, sheet, head, body, cat) {
  sprintf(
    '<c:ser>
     <c:idx val="%s" />
     <c:order val="%s" />
     ...
     <c:extLst>
      <c:ext uri="{C3380CC4-5D6E-409C-BE32-E72D297353CC}" xmlns:c16="http://schemas.microsoft.com/office/drawing/2014/chart">
       <c16:uniqueId val="{00000000-3636-684B-B8AB-0A17B70973AB}" />
      </c:ext>
     </c:extLst>
    </c:ser>',
    # id and position
...
### prepare files
barchart <- function(sheet_ref_head) {
  stringi::stri_join(
 ...
 <c:chart>
  ...
  <c:plotArea>
   ...
   <c:barChart>
    ...
    stringi::stri_join(
      vapply(seq_along(sheet_ref_head),
             function(x) {
               barchart_ser(
                 x-1,
                 sheet_ref_head[[x]]$sheet,
                 sheet_ref_head[[x]]$head,
                 sheet_ref_head[[x]]$body,
                 sheet_ref_head[[x]]$cat)
             },
             ""),
      collapse = ""
    ),
    ...
    <c:gapWidth val="219" />
    <c:overlap val="-27" />
    <c:axId val="1770107120" />
    <c:axId val="1604667776" />
   </c:barChart>
   <c:catAx>
    <c:axId val="1770107120" />
    <c:scaling>
