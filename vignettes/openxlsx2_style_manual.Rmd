...
write_data(wb, "test", mat, colNames = TRUE)
...
write_data(wb, "S1", x = df, startRow = 4, rowNames = FALSE)
write_datatable(wb, "S2", x = df, startRow = 4, rowNames = FALSE)
```
...
colnames(mat) <- make.names(seq_len(ncol(mat)))
write_data(wb, "test", mat, colNames = TRUE, startCol = 2, startRow = 2)
...
write_data(wb, sheet, mtcars, rowNames = TRUE)
