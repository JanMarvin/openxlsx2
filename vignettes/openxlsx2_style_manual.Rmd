...
wb <- wb_workbook() %>% 
  ...
  wb_add_fill("test", "A1:AB1", color = wb_color(rgb = "FF334E6F")) %>% 
  wb_add_font("test", "A1:AB1", name = "Arial", bold = "1", color= wb_color(rgb = "FFFFFFFF"), size = "20") %>%
...
new_fill <- create_fill(patternType = "solid", fgColor = wb_color(rgb = "FF334E6F"))
wb$styles_mgr$add(new_fill, "new_fill")

# create a font style and assign it to the workbook
new_font <- create_font(sz = "20", name = "Arial", b = "1", color = wb_color(rgb = "FFFFFFFF"))
...
wb$worksheets[[1]]$sheetPr <- xml_node_create(
  ...
  xml_children = xml_node_create(
    "tabColor",
    xml_attributes = wb_color(rgb = "FF00FF00")$get()))
