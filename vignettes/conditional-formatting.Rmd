...
knitr::include_graphics("cf_cells.png")
```
...
```{r echo=FALSE, warning=FALSE}
knitr::include_graphics("cf_moving_row.png")
```
...
```{r echo=FALSE, warning=FALSE}
knitr::include_graphics("cf_moving_col.png")
```
...
```{r echo=FALSE, warning=FALSE}
knitr::include_graphics("cf_dependent_on.png")
```
...
```{r echo=FALSE, warning=FALSE}
knitr::include_graphics("cf_duplicates.png")
```
...
```{r echo=FALSE, warning=FALSE}
knitr::include_graphics("cf_contains_text.png")
```
...
```{r echo=FALSE, warning=FALSE}
knitr::include_graphics("cf_contains_no_text.png")
```
...
```{r echo=FALSE, warning=FALSE}
knitr::include_graphics("cf_begins_with.png")
```
...
```{r echo=FALSE, warning=FALSE}
knitr::include_graphics("cf_ends_with.png")
```
...
knitr::include_graphics("cf_color_scale.png")
```
...
knitr::include_graphics("cf_databar.png")
```
...
```{r echo=FALSE, warning=FALSE}
knitr::include_graphics("cf_between.png")
```
...
```{r echo=FALSE, warning=FALSE}
knitr::include_graphics("cf_top_n.png")
```
...
```{r echo=FALSE, warning=FALSE}
knitr::include_graphics("cf_bottom_n.png")
```
...
```{r echo=FALSE, warning=FALSE}
knitr::include_graphics("cf_logical_operators.png")
```
